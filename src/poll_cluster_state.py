...
service_blacklist = ['hantaowang/lumbersexual', 'hantaowang/hotrod-seed', 'mchang6137/workloadlb', 'mchang6137/workloadmean', 'workloadlb', 'workloadmean', 'hotrodworkload', 'hotrodworkloadlb']
