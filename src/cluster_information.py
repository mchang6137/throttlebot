...
def get_instance_specs(machine_type, provider='aws-ec2'):
    resource_capacity = {
        ...
        'm3.medium':   {'CPU': 1,  'DISK': 0,   'NET': 0,    'MEMORY': 3.75, 'STORAGE': '1 x 4 SSD'},
        'm3.large':    {'CPU': 1,  'DISK': 0,   'NET': 0,    'MEMORY': 7.5,  'STORAGE': '1 x 32 SSD'},
        'm3.xlarge':   {'CPU': 2,  'DISK': 0,   'NET': 0,    'MEMORY': 15,   'STORAGE': '2 x 40 SSD'},
        'm3.2xlarge':  {'CPU': 4,  'DISK': 0,   'NET': 0,    'MEMORY': 30,   'STORAGE': '2 x 40 SSD'},
        'm4.large':    {'CPU': 1,  'DISK': 71,  'NET': 450,  'MEMORY': 8,    'STORAGE': 'ebsonly'},
        'm4.xlarge':   {'CPU': 2,  'DISK': 119, 'NET': 750,  'MEMORY': 16,   'STORAGE': 'ebsonly'},
        'm4.2xlarge':  {'CPU': 4,  'DISK': 159, 'NET': 1000, 'MEMORY': 32,   'STORAGE': 'ebsonly'},
        'm4.4xlarge':  {'CPU': 8,  'DISK': 174, 'NET': 2000, 'MEMORY': 64,   'STORAGE': 'ebsonly'},
        'm4.10xlarge': {'CPU': 20, 'DISK': 174, 'NET': 4000, 'MEMORY': 160,  'STORAGE': 'ebsonly'},
        'm4.16xlarge': {'CPU': 32, 'DISK': 174, 'NET': 4700, 'MEMORY': 256,  'STORAGE': 'ebsonly'},
        ...
        'c3.large':    {'CPU': 1,  'DISK': 0,   'NET': 0,    'MEMORY': 3.75, 'STORAGE': '2 x 16 SSD'},
        'c3.xlarge':   {'CPU': 2,  'DISK': 0,   'NET': 0,    'MEMORY': 7.5,  'STORAGE': '2 x 40 SSD'},
        'c3.2xlarge':  {'CPU': 4,  'DISK': 0,   'NET': 0,    'MEMORY': 15,   'STORAGE': '2 x 80 SSD'},
        'c3.4xlarge':  {'CPU': 8,  'DISK': 0,   'NET': 0,    'MEMORY': 30,   'STORAGE': '2 x 160 SSD'},
        'c3.8xlarge':  {'CPU': 16, 'DISK': 0,   'NET': 0,    'MEMORY': 60,   'STORAGE': '2 x 320 SSD'},
        'c4.large':    {'CPU': 1,  'DISK': 80,  'NET': 725,  'MEMORY': 3.75, 'STORAGE': 'ebsonly'},
        'c4.xlarge':   {'CPU': 2,  'DISK': 119, 'NET': 870,  'MEMORY': 7.5,  'STORAGE': 'ebsonly'},
        'c4.2xlarge':  {'CPU': 4,  'DISK': 158, 'NET': 2300, 'MEMORY': 15,   'STORAGE': 'ebsonly'},
        'c4.4xlarge':  {'CPU': 8,  'DISK': 174, 'NET': 3900, 'MEMORY': 30,   'STORAGE': 'ebsonly'},
        'c4.8xlarge':  {'CPU': 18, 'DISK': 174, 'NET': 4000, 'MEMORY': 60,   'STORAGE': 'ebsonly'},
        ...
        'r3.large':    {'CPU': 1,  'DISK': 0,   'NET': 0,    'MEMORY': 15,   'STORAGE': '1 x 32 SSD'},
        'r3.xlarge':   {'CPU': 2,  'DISK': 0,   'NET': 0,    'MEMORY': 30.5, 'STORAGE': '1 x 80 SSD'},
        'r3.2xlarge':  {'CPU': 4,  'DISK': 0,   'NET': 0,    'MEMORY': 61,   'STORAGE': '1 x 160 SSD'},
        'r3.4xlarge':  {'CPU': 8,  'DISK': 0,   'NET': 0,    'MEMORY': 122,  'STORAGE': '1 x 320 SSD'},
        'r3.8xlarge':  {'CPU': 16, 'DISK': 0,   'NET': 0,    'MEMORY': 244,  'STORAGE': '2 x 320 SSD'},
        ...
        'i2.xlarge':   {'CPU': 2,  'DISK': 0,   'NET': 0,    'MEMORY': 4,  'STORAGE': '1 x 800 SSD'},
        'i2.2xlarge':  {'CPU': 4,  'DISK': 0,   'NET': 0,    'MEMORY': 8,  'STORAGE': '2 x 800 SSD'},
        'i2.4xlarge':  {'CPU': 8,  'DISK': 0,   'NET': 0,    'MEMORY': 16, 'STORAGE': '4 x 800'},
        'i2.8xlarge':  {'CPU': 16, 'DISK': 0,   'NET': 0,    'MEMORY': 32, 'STORAGE': '2 x 800 SSD'},
        'd2.xlarge':   {'CPU': 2,  'DISK': 0,   'NET': 0,    'MEMORY': 4,  'STORAGE': '3 x 2000 HDD'},
        'd2.2xlarge':  {'CPU': 4,  'DISK': 0,   'NET': 0,    'MEMORY': 8,  'STORAGE': '6 x 2000 HDD'},
        'd2.4xlarge':  {'CPU': 8,  'DISK': 0,   'NET': 0,    'MEMORY': 16, 'STORAGE': '12 x 2000 HDD'},
        'd2.8xlarge':  {'CPU': 18, 'DISK': 0,   'NET': 0,    'MEMORY': 36, 'STORAGE': '24 x 2000 HDD'}
    }    
