...
def get_instance_specs(machine_type, provider='aws-ec2'):
    resource_capacity = {
        ...
        # Network is only correct for m4.large m4.xlarge and m4.2xlarge
        'm4.large':    {'CPU-CORE': 2,  'DISK': 71,  'NET': 700,  'MEMORY': 8000000000,    'STORAGE': 'ebsonly'}, 
        'm4.xlarge':   {'CPU-CORE': 4,  'DISK': 119, 'NET': 1000,  'MEMORY': 16,   'STORAGE': 'ebsonly'},
        'm4.2xlarge':  {'CPU-CORE': 8,  'DISK': 159, 'NET': 1300, 'MEMORY': 34359738368,   'STORAGE': 'ebsonly'},
        ...
        'c4.large':    {'CPU-CORE': 2,  'DISK': 80,  'NET': 1150,  'MEMORY': 3750000000, 'STORAGE': 'ebsonly'},
        'c4.xlarge':   {'CPU-CORE': 4,  'DISK': 119, 'NET': 1550,  'MEMORY': 7.5,  'STORAGE': 'ebsonly'},
        'c4.2xlarge':  {'CPU-CORE': 8,  'DISK': 158, 'NET': 2500, 'MEMORY': 15,   'STORAGE': 'ebsonly'},
