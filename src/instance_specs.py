...
def get_instance_specs(machine_type, provider='aws-ec2'):
    resource_capacity = {
        ...
        'c4.large':    {'CPU-CORE': 2,  'DISK': 80,  'NET': 500,  'MEMORY': 3.75, 'STORAGE': 'ebsonly'},
        'c4.xlarge':   {'CPU-CORE': 4,  'DISK': 119, 'NET': 750,  'MEMORY': 7.5,  'STORAGE': 'ebsonly'},
        'c4.2xlarge':  {'CPU-CORE': 8,  'DISK': 158, 'NET': 1000, 'MEMORY': 15,   'STORAGE': 'ebsonly'},
