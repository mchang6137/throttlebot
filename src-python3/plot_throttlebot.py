...
plot_99_list = list(iteration_99.values())
plot_100_list = list(iteration_100.values())
plot_0_list = list(iteration_0.values())

iterations = list(iteration_99.keys())

fig = plt.figure()
ax1 = fig.add_subplot(111)
ax1.scatter(list(iteration_0.keys()), list(iteration_0.values()), s=10, c='b', marker="s", label='0th')
ax1.scatter(list(iteration_100.keys()), list(iteration_100.values()), c='r', marker="o", label='100th')
ax1.scatter(list(iteration_99.keys()), list(iteration_99.values()), c='g', marker='x', label='99th')
